<template>
  <div class="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
    ...
    <h2 class="text-2xl font-display font-semibold mt-8 mb-4">Contact</h2>
    <p class="mb-5 leading-7">
      For privacy, legal, or copyright questions, use the current maintainer
      contact channel published with the project or wherever the service was
      shared. Do not include sensitive personal data in public channels.
    </p>
  </div>
</template>
